...
class GameLogger:
    def __init__(self,
        ...
        filename = os.path.join(
            directory,
            f"{base_filename}_participant_{self.current_participant}.log"
        )
        # Configure logger
        logging.basicConfig(
            filename=filename,
    ...
    def log_turn_start(self):
        ...
        self.logger.info(
            f"Event: TurnStart | Participant: {self.current_participant}"
        )
